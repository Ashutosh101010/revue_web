...
class _ScrollableListTabViewState extends State<ScrollableListTabView> {
            ...
            itemBuilder: (context, index) {
              ...
              return ValueListenableBuilder<int>(
                  ...
                  builder: (_, i, __) {
                    ...
                    return Container(
                      height: 40,
                      margin: _kTabMargin,alignment: Alignment.center,
  ...
  Widget _buildTab(int index,bool select) {
    print((widget.tabs[index].tab.label as Text).data);
    // var tab = Text((widget.tabs[index].tab.label as Text).data);
    var tab = widget.tabs[index].tab;
    if (tab.icon == null) return
      Padding(
        ...
        child: Column(
          children: [
            Text((widget.tabs[index].tab.label as Text).data,
            style: TextStyle(color: select?Colors.red:Colors.black,
                fontSize: select?18:16),),
            select?Padding(
              padding: const EdgeInsets.all(5.0),
              child: Container(color: Colors.red,height: 2,width: 70,),
            ):Container()
          ],
        ),
      );
    return Row(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
      mainAxisSize: MainAxisSize.min,
      children: [tab.icon, _kSizedBoxW8,Text("adasfs",
